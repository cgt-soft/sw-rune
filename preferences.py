...
default_settings = {'rune_sets': ['Energy', 'Swift', 'Blade', 'Fatal', 'Despair', 'Violent', 'Focus', 'Guard',
                                  'Endure', 'Shield', 'Revenge', 'Rage', 'Will', 'Nemesis', 'Vampire', 'Destroy', '???'],
                    'substat_weights': {'HP' : 1.0, 'DEF' : 1.0, 'SPD' : 1.2, 'CR' : 1.8, 'CD' : 1.8, 'ATK': 1.0,
                                        'RES' : 0.6, 'ACC' : 0.6},
                    'monster_types': {   'TNK': {    'SETS' : ['Energy', 'Guard', 'Endure', 'Shield', 'Revenge',
                                                               'Will', 'Nemesis', 'Focus', '???'],
                                                     'SUBS' : ['HP', 'DEF', 'RES']},
                                         'PDD': {    'SETS' : ['Fatal', 'Rage', 'Blade', 'Will', 'Nemesis', 'Vampire',
                                                               'Destroy', '???'],
                                                     'SUBS' : ['ATK', 'CR', 'CD']},
                                         'VDD': {    'SETS' : ['Violent', 'Blade', 'Will', 'Nemesis', 'Vampire',
                                                               'Destroy', '???'],
                                                     'SUBS' : ['ATK', 'CR', 'CD']},
                                         'SDD': {    'SETS' : ['Violent', 'Fatal', 'Rage', 'Will', 'Blade', 'Will',
                                                               'Nemesis', 'Vampire', 'Destroy', 'Swift', 'Revenge', '???'],
                                                     'SUBS' : ['ATK', 'CR', 'CD', 'SPD']},
                                         'ADD': {    'SETS' : ['Violent', 'Blade', 'Will', 'Nemesis', 'Vampire',
                                                               'Destroy', 'Revenge', 'Focus', 'Revenge', '???'],
                                                     'SUBS' : ['ATK', 'CR', 'CD', 'ACC']},
                                         'RDD': {    'SETS' : ['Violent', 'Fatal', 'Rage', 'Vampire', 'Blade', 'Will',
                                                               'Nemesis', 'Revenge', 'Endure', '???'],
                                                     'SUBS' : ['ATK', 'CR', 'CD', 'RES']},
